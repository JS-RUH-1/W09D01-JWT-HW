    ...
    return (
        <div className="addBook">
            ...
            <form className="bookForm" onSubmit={hnadleSubmit}>
                ...
                <input type="text" value={addBookDecode.username} className="input username" readOnly />
                <label>Book Title: </label>
                <input type="text" className="input" onChange={e => setTitle(e.target.value)}/>
                <label>Book Description: </label>
                <textarea type="text" className="input" onChange={e => setDesc(e.target.value)}/>
                <label>Book Author: </label>
                <input type="text" className="input" onChange={e => setAuthor(e.target.value)}/>
                <label>Book Price: </label>
                <input type="number" className="input" onChange={e => setPrice(e.target.value)}/>
                ...
                <button className="btnBook" type="submit">Publish</button>
            </form>
        </div>
    )
}
